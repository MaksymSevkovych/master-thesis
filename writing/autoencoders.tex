...
\begin{center}
   \begin{minipage}[b]{0.49\linewidth}
	...
	\end{minipage}
   \begin{minipage}[b]{0.49\linewidth}
      \includegraphics[width=\linewidth]{linear_AE_2d_adam_reconstruction}
	\end{minipage}
\end{center}
...
\begin{center}
   \begin{minipage}[b]{0.49\linewidth}
	...
	\end{minipage}
	\begin{minipage}[b]{0.49\linewidth}
      \includegraphics[width=\linewidth]{linear_AE_2d_amsgrad_reconstruction}
	\end{minipage}
\end{center}
