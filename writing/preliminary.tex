...
\end{align*}
If we now consider the fact, that $\b_{1t}\leq \b_1$ for all $t=1,\ldots,T$ and the following two observations
\begin{align*}
\frac{\hat{v}_{t,i}^{1/2}}{\a_t} &\geq \frac{\hat{v}_{t-1,i}^{1/2}}{\a_{t-1}},\\
