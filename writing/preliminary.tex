...
However, loss functions only measure the error between one prediction and one data point. In order to compare the predictions over a wide range of data points, we need to introduce another quantity, the risk function.
