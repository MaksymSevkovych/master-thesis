...
\end{align*}
which we can do, since we consider the risk $\risk_{\loss, D}(f_t)$ function in the parameters $\t_t$. \textcolor{red}{Cite the subdifferential inequality (?) at this point!!}\\
